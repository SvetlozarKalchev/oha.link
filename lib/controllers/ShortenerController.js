'use strict';
let ShortenerConstructor = require('../models/Shortener.js'),
  RandomConstructor = require('../models/RandomGenerator.js');

let Shortener = new ShortenerConstructor(),
  Random = new RandomConstructor();
/*
