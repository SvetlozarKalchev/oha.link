'use strict';
let DataBaseConstructor = require('./Database.js'),
  RandomConstructor = require('./RandomGenerator.js'),
  baseURL = require('../../CONFIG.js').BASE_URL,
  linksDbAdress = require('../../CONFIG.js').DB_URL;


let DataBase = new DataBaseConstructor(linksDbAdress);
let Random = new RandomConstructor();
